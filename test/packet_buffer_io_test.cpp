...
TEST(PacketBufferIO, PacketBufferReadWorksWithDataFieldHeader) {
  /**
...
TEST(PacketBufferIO, PacketBufferReadWorksWithoutDataFieldHeader) {
  /**
   * Define a packet of verification service acceptance success
   *    (subtype 1) that is as follows:
   * 
...
TEST(PacketBufferIO, PacketBufferWriteWorksWithoutDataFieldHeader) {
  /**
   * Define a packet of verification service acceptance success
   *    (subtype 1) that is as follows:
   * 
